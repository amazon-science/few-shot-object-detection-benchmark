...
class OpenImagesWriterFromCOCO:
    ...
    def convert_files(self):
        ...
        train_ids, test_ids = train_test_split(imgIds, test_size=0.2, random_state=42)
        for cur_set in ['train', 'test']:
            ...
            if cur_set =='train':
                ...
                cur_ids = test_ids
            for i, imgId in enumerate(cur_ids):
                if i % 1000 == 0:
                    print(i, len(cur_ids))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='OI_Annotations', help='Output oi_fles folder')
